...
public class GalleryAdapter extends ArrayAdapter<ImageBean>{
	...
	public GalleryAdapter(HomeView activity, int textViewResourceId,	ArrayList<ImageBean> items) {
	...
	public View getView( final int position,  View convertView, ViewGroup parent) {
		...
		mHolder.image.setOnClickListener(new OnClickListener()	{
			...
			public void onClick(View v)	{
			    ...
			    Global.galleryItem = mItems;
			    Log.e("Item Size", ""+mItems.size());
